 ...
 */
public class GhistoryFragment extends Fragment implements OnMapReadyCallback,RapidFloatingActionContentLabelList.OnRapidFloatingActionContentLabelListListener
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        helper= GDatabaseHelper.getInstance(historyContext);
        ...
        personlist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        try {
                            ...
                            Log.e("History studid---------", GhistoryFragment.StudentId + "----"+position);
        ...
        fab_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (GhistoryFragment.StudentId!=0){
                    clearHistoryData();
                    ...
                    i.putExtra("StudentId", GhistoryFragment.StudentId);
    ...
    {
        GDatabaseHelper helper= GDatabaseHelper.getInstance(historyContext);
        String trackSTring="{}";
        try{
...
//        LoginActivity.mClient.sendMessage(makeJSONHistory(formattedDate));
    ...
    public static void addDefaultLocations() {
        ...
        GDatabaseHelper dbH= GDatabaseHelper.getInstance(historyContext);
