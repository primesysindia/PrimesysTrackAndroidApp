...
import com.primesys.VehicalTracking.Guest.Adpter.GVhehicalReportlistAdpter;
 ...
 */
public class GACCReport extends Fragment {
    ...
    public GVhehicalReportlistAdpter mAdpter;
    ...
    public void CheckStudent(Context context1) {
        helper = GDatabaseHelper.getInstance(context1);
...
*/
   /* private void GetVehReportlist() {
    ...
    private void SetreportListData() {
        ...
        mAdpter = new GVhehicalReportlistAdpter(smslistdata, R.layout.row_smslist, context);
