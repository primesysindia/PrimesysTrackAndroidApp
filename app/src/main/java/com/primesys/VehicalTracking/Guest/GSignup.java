...
public class GSignup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_name.setText(sharedPreferences.getString("Gname",""));
        text_mobileno.setText(sharedPreferences.getString("Gmob",""));
        text_email.setText(sharedPreferences.getString("Gemail",""));
    ...
    boolean valid()
    {
        ...
        if(name.length()==0)
        {
            ...
            Common.ShowSweetAlert(context, "Please enter name!");
        ...
        else if(email.length()==0)
        {
            ...
            Common.ShowSweetAlert(context, "Please email-Id!");
        ...
        else if(!email.matches(Common.EMAIL_REGEX))
        {
            ...
            Common.ShowSweetAlert(context, "Please enter valid email-Id!");
        ...
        else if(mobileno.length()==0)
        {
            ...
            Common.ShowSweetAlert(context, "Please enter mobile number!");
        ...
        else if(!mobileno.matches(MOB_NO))
        {
            ...
            Common.ShowSweetAlert(context, "Mobile number must be 10 digit !");
    ...
    void postGuestUserRequest()
    {
        ...
        stringRequest = new StringRequest(Request.Method.POST, Common.TrackURL+"UserServiceAPI/postGuestUserRequest",new Response.Listener<String>() {
        ...
        System.err.println(result);
            ...
            try
            {
                ...
                if (!jo.getString("error").equalsIgnoreCase("True")){
                    ...
                    editor.putString("Gmob",mobileno);
                  editor.commit();


                    Intent guest=new Intent(context, GHomeTab.class);
                    startActivity(guest);

                }else{
                    Common.ShowSweetAlert(context,"Not register successfully.Please try again");
                }
            }
            catch(Exception e)
            {
