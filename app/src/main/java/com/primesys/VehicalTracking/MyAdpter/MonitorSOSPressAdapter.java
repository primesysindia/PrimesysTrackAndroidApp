...
public class MonitorSOSPressAdapter extends RecyclerView.Adapter<MonitorSOSPressAdapter.ViewHolder>{
    ...
    public MonitorSOSPressAdapter(Context mContext, int card_device_sos_report, ArrayList<MonitorSOSPressDTO> deviceInfoList) {
        super();
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        try {
          //  NearbyFeatureCodeDTO item = dataList.get(position);
            ...
            holder.tv_device_address.setText("Address :"+dataList.get(position).getAddress());
            ...
            holder.tv_speed.setText("Speed :"+dataList.get(position).getSpeed());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        public TextView tv_device_name, tv_device_address, tv_time, tv_gsm_signal_strength, tv_speed, tv_voltage_level;

        LinearLayout lay_report;
        public ViewHolder(View itemView) {
            super(itemView);
            tv_device_name = (TextView) itemView.findViewById(R.id.tv_device_name);
            tv_device_address = (TextView) itemView.findViewById(R.id.tv_device_status);
