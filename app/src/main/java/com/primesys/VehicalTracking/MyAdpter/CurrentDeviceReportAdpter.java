...
public class CurrentDeviceReportAdpter extends RecyclerView.Adapter<CurrentDeviceReportAdpter.ViewHolder>{
    ...
    public CurrentDeviceReportAdpter(Context mContext, int card_device_current_report, ArrayList<RailDeviceInfoDto> deviceInfoList) {
        super();
...
/*
    public CurrentDeviceReportAdpter(ArrayList<RailDeviceInfoDto> listdata, int row_reportlist, Context context) {
        ...
        try {
          //  RailDeviceInfoDto item = dataList.get(position);
            ...
            if (dataList.get(position).getDeviceOnStatus()==0){
                ...
                if (dataList.get(position).getTime()!=null&&!dataList.get(position).getTime().equalsIgnoreCase("null")&&!dataList.get(position).getTime().equalsIgnoreCase("0"))
                {
                    holder.tv_lasttime.setText("Last Location Time : "+Common.getDateCurrentTimeZone(Long.parseLong(dataList.get(position).getTime())));
                   // holder.tv_location.setText("Address : "+dataList.get(position).getAddress());
                ...
                {
                    holder.tv_lasttime.setVisibility(View.GONE);
                    holder.tv_location.setVisibility(View.GONE);
                    holder.tv_location.setText("Address : Location not found ");
                ...
                if (dataList.get(position).getRailFeatureDto()!=null){
                    ...
                    if (Common.FeatureAddressEnable)
                    {
                        ...
                        holder.lay_report.setBackgroundColor(mContext.getResources().getColor(R.color.light_yellow));
