 ...
 */
    ...
    public class VhehicalAcclistAdpter extends RecyclerView.Adapter<VhehicalAcclistAdpter.ViewHolder>{
        ...
        public VhehicalAcclistAdpter(ArrayList<SmsNotificationDTO> smslistdata, int row_smslist, Context context) {
            super();
